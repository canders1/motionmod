...
cbbPalette <- c("#000000", "#56B4E9", "#0072B2", "#CC79A7", "#D55E00")
```
...
shared_a_pairs <- shared_pairs %>% mutate(Participant = "A",
                            belief = ifelse(speaker=="a",speaker_belief,listener_belief))
shared_b_pairs <- shared_pairs %>% mutate(Participant = "B",
                            belief = ifelse(speaker=="b",speaker_belief,listener_belief))
shared_pairs_ab <- rbind(shared_a_pairs,shared_b_pairs)

shared_pairs_beliefs <- shared_pairs_ab %>% mutate(prob = belief,
                                                   Type = paste(Participant,"Belief",sep=" "))
shared_pairs_cgs <- shared_pairs_ab %>% mutate(prob = cg_prob,
                                                      Type = paste(Participant,"CG",sep=" "))
shared_pairs_all <- rbind(shared_pairs_cgs,shared_pairs_beliefs)

ggplot(data=subset(shared_pairs,generation > 0 & generation < 5 & w_idx != -1),aes(x=name,y=cg_prob)) + geom_col(position="dodge") + facet_wrap(~genUtt) + ylim(0,1) + ylab("P(w)") + scale_x_discrete(name="World") + theme(legend.position="none",text=element_text(size=14), plot.margin=grid::unit(c(0,0,0,0), "mm"),axis.text.x = element_text(angle = 90)) + scale_fill_manual(values=cbbPalette)
ggsave("weighted_shared_fixed_balanced_Nancy_none_lr02all_8_SHOW_noconvergence.pdf")

ggplot(data=subset(shared_pairs_all,generation > 0 & generation < 5 & w_idx != -1),aes(x=name,y=prob,fill=Type)) + geom_col(position="dodge") + facet_wrap(~genUtt) + ylim(0,1) + ylab("P(w)") + scale_x_discrete(name="World") + theme(text=element_text(size=16),axis.text.x = element_text(angle = 90)) + scale_fill_manual(values=cbbPalette)
ggsave("weighted_shared_fixed_balanced_Nancy_none_lr02all_8_SHOW_noconvergence_2.pdf")
```
...
approx_fixed_b_pairs <-approx_fixed_pairs %>% mutate(cg_prob = ifelse(speaker=="b",cg_listener_prob,cg_speaker_prob),
                                                     Participant = "B",
                            belief = ifelse(speaker=="b",speaker_belief,listener_belief))
approx_fixed_pairs_ab <- rbind(approx_fixed_a_pairs,approx_fixed_b_pairs)
approx_fixed_pairs_all <- rbind(approx_fixed_a_pairs,approx_fixed_b_pairs)

approx_fixed_pairs_beliefs <- approx_fixed_pairs_ab %>% mutate(prob = belief,
                                                                 Type = paste(Participant,"Belief",sep=" "))
approx_fixed_pairs_cgs <- approx_fixed_pairs_ab %>% mutate(prob = cg_prob,
                                                             Type = paste(Participant,"CG",sep=" "))
approx_fixed_pairs_all2 <- rbind(approx_fixed_pairs_cgs,approx_fixed_pairs_beliefs)

ggplot(data=subset(approx_fixed_pairs_all,generation > 0 & generation < 5 & w_idx != -1),aes(x=name,y=cg_prob,fill=Participant)) + geom_col(position="dodge") + facet_wrap(~genUtt,nrow=1) + ylab("P(w)") + scale_x_discrete(name="World") + ylim(0,1)+ theme(text=element_text(size=14), plot.margin=grid::unit(c(0,0,0,0), "mm"),axis.text.x = element_text(angle = 90))
ggsave("weighted_approx_fixed_balanced_Nancy_none_lr02all_8.pdf",width=15, height=5)

ggplot(data=subset(approx_fixed_pairs_all2,generation > 0 & generation < 5 & w_idx != -1),aes(x=name,y=prob,fill=Type)) + geom_col(position="dodge") + facet_wrap(~genUtt,nrow=2) + ylab("P(w)") + scale_x_discrete(name="World") + ylim(0,1)+ theme(text=element_text(size=16),axis.text.x = element_text(angle = 90)) + scale_fill_manual(values=cbbPalette)
ggsave("weighted_approx_fixed_balanced_Nancy_none_lr02all_8_2.pdf")

ggplot(data=subset(approx_fixed_pairs_all,generation == 1),aes(x=name,y=belief,fill=Participant)) + geom_col(position="dodge") + ylab("P(w)")+ ylim(0,1) + scale_x_discrete(name="World") + theme(text=element_text(size=14), plot.margin=grid::unit(c(0,0,0,0), "mm"),axis.text.x = element_text(angle = 90)) + scale_fill_manual(values=cbbPalette)
...
ggplot(data=subset(approx_update_pairs_all,generation > 0 & generation < 5 & w_idx != -1),aes(x=name,y=prob,fill=Type)) + geom_col(position="dodge") + facet_wrap(~genUtt) + ylim(0,1) + ylab("P(w)") + scale_x_discrete(name="World") + theme(text=element_text(size=16),axis.text.x = element_text(angle = 90)) + scale_fill_manual(values=cbbPalette)
...
ggplot(data=subset(shared_pairs,generation > 0 & generation < 5 & w_idx != -1),aes(x=name,y=cg_prob)) + geom_col(position="dodge") + facet_wrap(~genUtt) + ylim(0,1) + ylab("P(w)") + scale_x_discrete(name="World") + theme(legend.position="none",text=element_text(size=14),axis.text.x = element_text(angle = 90)) + scale_fill_manual(values=cbbPalette)
ggsave("threshold03_shared_fixed_balanced_Nancy_none_lr02all_8_SHOW_convergence.pdf")

ggplot(data=subset(shared_pairs_all,generation > 0 & generation < 5 & w_idx != -1),aes(x=name,y=prob,fill=Type)) + geom_col(position="dodge") + facet_wrap(~genUtt) + ylim(0,1) + ylab("P(w)") + scale_x_discrete(name="World") + theme(text=element_text(size=16),axis.text.x = element_text(angle = 90)) + scale_fill_manual(values=cbbPalette)
ggsave("threshold03_shared_fixed_balanced_Nancy_none_lr02all_8_SHOW_convergence_2.pdf")
```
...
ggplot(data=subset(approx_update_pairs_all,generation > 0 & w_idx != -1),aes(x=name,y=prob,fill=Type)) + geom_col(position="dodge") + facet_wrap(~genUtt) + ylim(0,1) + ylab("P(w)") + scale_x_discrete(name="World") + theme(text=element_text(size=14), plot.margin=grid::unit(c(0,0,0,0), "mm"),axis.text.x = element_text(angle = 90)) + scale_fill_manual(values=cbbPalette)
...
ggplot(data=subset(approx_update_pairs_all,generation > 0 & generation < 5 & w_idx != -1),aes(x=name,y=prob,fill=Type)) + geom_col(position="dodge") + facet_wrap(~genUtt) + ylim(0,1) + ylab("P(w)") + scale_x_discrete(name="World") + theme(text=element_text(size=14), plot.margin=grid::unit(c(0,0,0,0), "mm"),axis.text.x = element_text(angle = 90)) + scale_fill_manual(values=cbbPalette)
...
ggplot(data=subset(approx_update_pairs_all,generation > 0 & generation < 7 & w_idx != -1),aes(x=name,y=prob,fill=Type)) + geom_col(position="dodge") + facet_wrap(~genUtt) + ylim(0,1) + ylab("P(w)") + scale_x_discrete(name="World") + theme(text=element_text(size=14),axis.text.x = element_text(angle = 90)) + scale_fill_manual(values=cbbPalette)
ggsave("weighted_approx_update_balanced_Nancy_Katie_lr02all_8.pdf",width=15, height=5)
```

```{r}
# Weighted sampling, both have strong beliefs (Nancy and Katie, both outdoors), lr=0.3

approx_update_pairs <- read.csv('~/dissertation/modeling/motionmod/scil2020/weighted_approx_update_balanced_Nancy_Katie_lr03all_8.tsv',header=TRUE,comment.char = "#")
...
ggplot(data=subset(approx_update_pairs_all,generation > 0 & generation < 7 & w_idx != -1),aes(x=name,y=prob,fill=Type)) + geom_col(position="dodge") + facet_wrap(~genUtt) + ylim(0,1) + ylab("P(w)") + scale_x_discrete(name="World") + theme(text=element_text(size=12),axis.text.x = element_text(angle = 90), legend.position="none") + scale_fill_manual(values=cbbPalette)
ggsave("weighted_approx_update_balanced_Nancy_Katie_lr03all_8.pdf")
```
...
ggplot(data=subset(approx_update_pairs_all,generation > 0 & generation < 7 & w_idx != -1),aes(x=name,y=prob,fill=Type)) + geom_col(position="dodge") + facet_wrap(~genUtt) + ylim(0,1) + ylab("P(w)") + scale_x_discrete(name="World") + theme(text=element_text(size=12),axis.text.x = element_text(angle = 90)) + scale_fill_manual(values=cbbPalette)
ggsave("weighted_approx_update_balanced_Nancy_Katie_suspicious0201_8.pdf")
```

```{r}
# More suspicious Listener, Weighted sampling, both have strong beliefs (Nancy and Katie, both outdoors) 

approx_fixed_pairs <- read.csv('~/dissertation/modeling/motionmod/scil2020/weighted_approx_fixed_balanced_Nancy_Katie_more_suspicious0201_8.tsv',header=TRUE,comment.char = "#")
approx_update_pairs <- read.csv('~/dissertation/modeling/motionmod/scil2020/weighted_approx_update_balanced_Nancy_Katie_more_suspicious0201_8.tsv',header=TRUE,comment.char = "#")
...
ggplot(data=subset(approx_fixed_pairs_all,generation > 0 & generation < 5 & w_idx != -1),aes(x=name,y=cg_prob,fill=Participant)) + geom_col(position="dodge") + facet_wrap(~genUtt,nrow=1) + ylab("P(w)") + scale_x_discrete(name="World") + ylim(0,1)+ theme(text=element_text(size=14), plot.margin=grid::unit(c(0,0,0,0), "mm"),axis.text.x = element_text(angle = 90)) + scale_fill_manual(values=cbbPalette)
ggsave("weighted_approx_fixed_balanced_Nancy_Katie_more_suspicious0201_8.pdf",width=15, height=5)
...
ggplot(data=subset(approx_update_pairs_all,generation > 0 & generation < 7 & w_idx != -1),aes(x=name,y=prob,fill=Type)) + geom_col(position="dodge") + facet_wrap(~genUtt) + ylim(0,1) + ylab("P(w)") + scale_x_discrete(name="World") + theme(text=element_text(size=12),axis.text.x = element_text(angle = 90), legend.position="bottom") + scale_fill_manual(values=cbbPalette)
ggsave("weighted_approx_update_balanced_Nancy_Katie_more_suspicious0201_8.pdf")
```
...
ggplot(data=subset(shared_pairs,generation > 0  & w_idx != -1),aes(x=name,y=cg_prob)) + geom_col(position="dodge") + facet_wrap(~genUtt) + ylim(0,1) + ylab("P(w)") + scale_x_discrete(name="World") + theme(legend.position="none",text=element_text(size=14), plot.margin=grid::unit(c(0,0,0,0), "mm"),axis.text.x = element_text(angle = 90)) + scale_fill_manual(values=cbbPalette)
...
ggplot(data=subset(shared_pairs_all,generation > 0 & w_idx != -1),aes(x=name,y=prob, fill=Type)) + geom_col(position="dodge") + facet_wrap(~genUtt) + ylim(0,1) + ylab("P(w)") + scale_x_discrete(name="World") + theme(text=element_text(size=14), plot.margin=grid::unit(c(0,0,0,0), "mm"),axis.text.x = element_text(angle = 90)) + scale_fill_manual(values=cbbPalette)
...
ggplot(data=subset(approx_update_pairs_all,generation > 0 & generation < 7 & w_idx != -1),aes(x=name,y=prob,fill=Type)) + geom_col(position="dodge") + facet_wrap(~genUtt) + ylim(0,1) + ylab("P(w)") + scale_x_discrete(name="World") + theme(text=element_text(size=13),axis.text.x = element_text(angle = 90), legend.position="bottom") + scale_fill_manual(values=cbbPalette)
...
ggplot(data=subset(approx_fixed_pairs_all,generation > 0 & generation < 7 & w_idx != -1),aes(x=name,y=cg_prob,fill=Participant)) + geom_col(position="dodge") + facet_wrap(~genUtt) + ylab("P(w)") + scale_x_discrete(name="World") + ylim(0,1)+ theme(text=element_text(size=14), plot.margin=grid::unit(c(0,0,0,0), "mm"),axis.text.x = element_text(angle = 90)) + scale_fill_manual(values=cbbPalette)
...
```{r}
# Entropy-based learning rate, B uninformed

approx_update_pairs <- read.csv('~/dissertation/modeling/motionmod/scil2020/weighted_approx_update_balanced_Nancy_none_lrentropy01035_8.tsv',header=TRUE,comment.char = "#")
...
ggplot(data=subset(approx_update_pairs_all,generation > 0 & generation < 7 &  w_idx != -1),aes(x=name,y=prob,fill=Type)) + geom_col(position="dodge") + facet_wrap(~genUtt) + ylim(0,1) + ylab("P(w)") + scale_x_discrete(name="World") + theme(text=element_text(size=13),axis.text.x = element_text(angle = 90), legend.position="bottom") + scale_fill_manual(values=cbbPalette)
ggsave("weighted_approx_update_balanced_Nancy_none_lrentropy01035_8.pdf")
```