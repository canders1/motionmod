...
ggsave(paste0(datad,"Tmove05_noprob.png"),width=12, height=5)
```
...
ggsave(paste0(datad,"wmarg2_Tmove_noprob.png"),width=12, height=5)
```
...
ggsave(paste0(datad,"moveThelma0_noprob.png"),width=14, height=7)
```
...
ggsave(paste0(datad,"moveS05.png"),width=14, height=7)
```
...
ggsave(paste0(datad,"moveS0_noprob.png"),width=14, height=7)
```
...
ggsave(paste0(datad,"moveL0_noprob.png"),width=14, height=7)
```
