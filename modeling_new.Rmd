...
prob.pairs <- read.csv('~/Documents/modeling/motionmod/all_prob.csv',header=TRUE,col.names=n,comment.char = "#")
...
c05_moveThelma <- subset(moveThelma,cost==0.0)
...
```
```{r}
pmarg_c05_moveThelma <- subset(pmarg_moveThelma,cost==0.75)
