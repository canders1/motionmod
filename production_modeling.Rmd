...
prob.pairs <- read.csv('~/Documents/modeling/motionmod/speaker_aug_prob.csv',header=TRUE,col.names=n,comment.char = "#")
nogop.pairs <- read.csv('~/Documents/modeling/motionmod/speaker_aug_nogop.csv',header=TRUE,col.names=n,comment.char = "#")

gop.pairs <- read.csv('~/Documents/modeling/motionmod/speaker_aug_gop.csv',header=TRUE,col.names=n,comment.char = "#")
...
ggsave("speak_Tmove_cost05.png",width=12, height=5)
```
```{r}
...
ggsave("speak_pmarg_nogopTmove.png",width=12, height=5)
```
```{r}
...
ggsave("speak_wmarg_nogopTmove.png",width=12, height=5)
```
```{r}
...
ggsave("speak_pmarg_c05_Tmove.png",width=12, height=5)
```
```{r}
...
ggsave("speak_wmarg_c05_Tmove.png",width=12, height=5)
```
...
ggsave("speak_goAtrueC.png",width=12, height=5)
```
```{r}
...
ggsave("speak_goTtrueC.png",width=12, height=5)
```
```{r}
...
ggsave("speak_goStrueC.png",width=12, height=5)
```
```{r}
...
ggsave("speak_moveEtrue05.png",width=14, height=7)
```
```{r}
...
ggsave("speak_moveEtrueC0.png",width=10, height=4)
```
