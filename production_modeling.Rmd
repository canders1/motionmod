...
if(datanm == "speaker_nonu_w"){
  nogop_n = 'speaker_nonu_aug_nogop.csv'
  gop_n = 'speaker_nonu_aug_gop.csv'
  prob_n = 'speaker_nonu_aug_prob.csv'
}
if(datanm == "speaker_speaker_bias"){
  nogop_n = 'speaker_speaker_bias_nogop.csv'
  gop_n = 'speaker_speaker_bias_gop.csv'
  prob_n = 'speaker_speaker_bias_prob.csv'
}
...
ggplot(data=moveThelma,mapping=aes(x=world,y=probability,size=cost,shape=utterance,color=perspective)) + geom_point() + facet_wrap(c1_moveThelma$go.is.p)
ggsave(paste0(datad,"Tmove.png"),width=12, height=5)
```
...
ggsave(paste0(datad,"Tmove_cost1.png"),width=12, height=5)
```
```{r}
...
ggsave(paste0(datad,"Tmove_cost0.png"),width=12, height=5)
```
...
ggsave(paste0(datad,"Tmove_cost0_noprob.png"),width=12, height=5)
```
...
ggsave(paste0(datad,"pmarg_Tmove_noprob.png"),width=12, height=5)
```
...
ggsave(paste0(datad,"speak_umarg_nogopTmove.png"),width=12, height=5)
```
...
ggsave(paste0(datad,"speak_umarg_nogopTmove_c0.png"),width=12, height=5)
```
```{r}
...
ggsave(paste0(datad,"speak_pmarg_Tmove.png"),width=12, height=5)
...
ggsave(paste0(datad,"speak_c05_pmarg_Tmove.png"),width=12, height=5)
```
```{r}
...
ggsave(paste0(datad,"speak_wmarg_c05_Tmove.png"),width=12, height=5)
```
...
ggsave(paste0(datad,"speak_goAtrueC.png"),width=12, height=5)
```
```{r}
...
ggsave(paste0(datad,"speak_goTtrueC.png"),width=12, height=5)
```
```{r}
...
ggsave(paste0(datad,"speak_goStrueC.png"),width=12, height=5)
```
```{r}
...
ggsave(paste0(datad,'speak_comeTtrueC.png'),width=12, height=5)
```
```{r}
...
ggsave(paste0(datad,'speak_comeStrueC.png'))
```
```{r}
...
ggsave(paste0(datad,'speak_comeACP.png'))
```
...
ggsave(paste0(datad,'speak_comeStruePC.png'))
```
```{r}
...
ggsave(paste0(datad,"speak_gotrueC.png"))
```
```{r}
...
ggsave(paste0(datad,"speak_gotrue05.png"))
```
...
ggsave(paste0(datad,"speak_moveEtrue05.png"),width=14, height=7)
```
```{r}
...
ggsave(paste0(datad,"speak_moveEtrueC0.png"),width=10, height=4)
```
