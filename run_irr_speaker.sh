...
webppl irrational_speaker.wppl $cost "prob" "speaker" > "irr_speaker_prob/irr_speaker_prob_$cost.txt"
...
cat irr_speaker_prob/irr_speaker_prob_*.txt > irr_speaker_prob/irr_speaker_prob.txt
...
python parse_irr_speaker_results.py irr_speaker_prob/irr_speaker_prob.txt prob irr_speaker_prob.csv
