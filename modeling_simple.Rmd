...
nogop.pairs <- read.csv('~/Documents/modeling/motionmod/simple_nogop.csv',header=TRUE,col.names=n,comment.char = "#")
#prob.pairs <- read.csv('~/Documents/modeling/motionmod/aug_prob.csv',header=TRUE,col.names=n,comment.char = "#")
gop.pairs <- read.csv('~/Documents/modeling/motionmod/simple_gop.csv',header=TRUE,col.names=n,comment.char = "#")
...
ggsave("simpleimg/Tmove_cost05.png",width=12, height=5)
```
```{r}
...
ggsave("simpleimg/pmarg_nogopTmove.png",width=12, height=5)
```
```{r}
...
ggsave("simpleimg/wmarg_nogopTmove.png",width=12, height=5)
```
```{r}
...
ggsave("simpleimg/pmarg_c05_Tmove.png",width=12, height=5)
```
```{r}
...
ggsave("simpleimg/wmarg_c05_Tmove.png",width=12, height=5)
```
...
ggsave("simpleimg/goAtrueC.png",width=12, height=5)
```
```{r}
...
ggsave("simpleimg/goTtrueC.png",width=12, height=5)
```
```{r}
...
ggsave("simpleimg/goStrueC.png",width=12, height=5)
```
```{r}
...
ggsave('simpleimg/comeTtrueC.png',width=12, height=5)
```
```{r}
...
ggsave('simpleimg/comeStrueC.png')
```
```{r}
...
ggsave('simpleimg/comeStruePC.png')
```
```{r}
...
ggsave("simpleimg/moveEtrue05.png",width=14, height=7)
```
```{r}
...
ggsave("simpleimg/moveEtrueC0.png",width=10, height=4)
```
