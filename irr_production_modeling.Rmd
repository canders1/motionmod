...
nogop.pairs <- read.csv('~/dissertation/modeling/motionmod/irr_speaker_nogop.csv',header=TRUE,col.names=n,comment.char = "#")

gop.pairs <- read.csv('~/dissertation/modeling/motionmod/irr_speaker_gop.csv',header=TRUE,col.names=n,comment.char = "#")
