...
```{r}
Condition <- c("Both","Speaker","Listener","None")
utterances <- c("Thelma is walking to Northampton","Thelma is coming to Northampton","Thelma is going to Northampton")
# Coming
marg.prob <- c(0.75,0.75,0.0,0.0)
utterance <- c("Thelma is coming to Northampton","Thelma is coming to Northampton","Thelma is coming to Northampton","Thelma is coming to Northampton")
coming <- cbind(Condition,marg.prob,utterance)

# Going
marg.prob <- c(0.0,0.0,0.75,0.75)
utterance <- c("Thelma is going to Northampton","Thelma is going to Northampton","Thelma is going to Northampton","Thelma is going to Northampton")
going <- cbind(Condition,marg.prob,utterance)

# Walking
marg.prob <- c(0.25,0.25,0.25,0.25)
utterance <- c("Thelma is walking to Northampton","Thelma is walking to Northampton","Thelma is walking to Northampton","Thelma is walking to Northampton")
